<template>
    <el-form :model="ruleForm" :rules="rules" ref="ruleform" label-width="100px" class="form-container">
        ...
        <el-form-item>
            <el-button type="primary" @click="submitForm('ruleForm')">Query Employee ID</el-button>
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        const _this = this
                        axios.post('http://localhost:8181/employee/findById',this.ruleForm).then(function (resp) {
                            if(resp.data == 1){
